...
public class HttpKit {
	 ...
	 * @throws IOException
	 */
	public static String doPostByProxy(String host, Map<String, String> params, String encode, String proxyIp,
			int proxyPort) throws IOException {
		Validate.notNull(host, "主机地址不能为null");
		Validate.notNull(params, "参数不能为null");
		Validate.notNull(proxyIp, "代理服务器ip不能为null");
	 ...
	 * @throws IOException
	 */
	public static String doGetByProxy(String host, String encode, String proxyIp, int proxyPort) throws IOException {
		Validate.notNull(host, "主机地址不能为null");
		Validate.notNull(proxyIp, "代理服务器ip不能为null");
