...
public class Encrypt {
	...
	/*
	 * 可传多个密码 encrypt the string to string made up of hex return the encrypted
	 * string
	 */
	...
	public static String strEncode(String data, String key) {
		return Encrypt.strEncode(data, key, "", "");
	}

	public static String strDecode(String data,String key){
		return Encrypt.strDecode(data,key,"","");
	}
	/*
	...
	public static void main(String[] args) {
		...
		String fKey = "JmGKE3NiI+k=";/* 必需的密钥 */
		String sKey = "";
		String tKey = "";

		String data = "knepw";
		String s = "0B144F8B25F08D30A1C6DACEF0E92E8D";
		String strs = Encrypt.strEncode(data, fKey);
		String decs = Encrypt.strDecode(strs, fKey);
