			...
			<tr>
				<td height="235" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px #99BBE8 solid;">
								...
								<fieldset style="color: #B7B7B7; border-style: groove;">
									...
									<table width="98%" border="0" cellpadding="4" cellspacing="1">
										<tr>
											...
											<td height="23" colspan="3" align="left"><select name="menu1" style="width: 190px" onchange="showtest(this,1)">
										...
										<tr>
											...
											<td height="23" colspan="5" align="left"><input type=text value='360' onkeypress="return event.keyCode>=48&&event.keyCode<=57" /> 天</td>
										</tr>
									</table>
								</fieldset>
							</td>
									...
									<table width="98%" border="0" cellpadding="4" cellspacing="1" bgcolor=#ffffff>
										...
										<tbody cellspacing="0" id="no1" name="no1">
											...
											<tr bgcolor=#ffffff>
												...
												<td height="23" align="left" width=137><select name="select" id="s1">
														<option>请选择</option>
												</select></td>
												<td class="color0366CB" width=100 align="right">市：</td>
												<td align="left" width=137><select name="select2" id="s2">
														<option>请选择</option>
												</select></td>
												<td class="color0366CB" width=100 align="right">县：</td>
												<td align="left"><select name="select3" id="s3">
														<option>请选择</option>
												</select></td>
											</tr>
										</tbody>
										...
										<tbody width="100%" cellspacing="0" id="no2" name="no2">
											<tr bgcolor=#ffffff>
												...
												<td height="23" align="left" colspan=5><select name="select4" id="s4" style="width: 100%">
														<option>请选择</option>
												</select></td>
											</tr>
											<tr bgcolor=#ffffff>
												<td class="color0366CB" width=100 height="23" align="right">一级单位：</td>
												<td height="23" align="left" colspan=5><select name="select5" id="s5" style="width: 100%">
														<option>请选择</option>
												</select></td>
											</tr>
											<tr bgcolor=#ffffff>
												<td class="color0366CB" width=100 height="23" align="right">二级单位：</td>
												<td height="23" align="left" colspan=5><select name="select6" id="s6" style="width: 100%">
														<option>请选择</option>
												</select></td>
											</tr>
										</tbody>
							...
							<td align="center" valign="middle" style="padding: 5px 5px 0px 5px;">
								<fieldset style="color: #B7B7B7; border-style: groove;">
									...
									<table width="98%" border="0" bgcolor=#ffffff>
										<tr id="userInfoTR" style="display: none">
											<td>&nbsp;</td>
										</tr>
										<tbody cellspacing="0" id="no7" name="no7">
											<tr bgcolor=#ffffff>
												<td class="color0366CB" width=100 align="right" height="23">姓名：</td>
												<td align="left" width=200><input type="text" style="width: 190px" /></td>
												<td class="color0366CB" width=100 height="23" align="right">身份证号：</td>
												<td align="left"><input id="idCard" type="text" style="width: 190px" /></td>
											</tr>
										</tbody>
										...
										<tbody width="100%" cellspacing="0" id="no3" name="no3">
											<tr bgcolor=#ffffff>
												...
												<td height="23" align="left" width=200><select name="select7" style="width: 190px">
														<option>请选择</option>
												...
												<td height="23" align="left"><select name="select8" style="width: 190px">
														<option>请选择</option>
						...
						<tr>
							<td height="23" id="no6" name="no6" style="text-align: center; padding: 5px 0px 5px 0px;"><input id="newCertButton" type="button" class="inp_L1" value="新申请" onmouseover="this.className='inp_L2'"
								onmouseout="this.className='inp_L1'" onclick="location.href='page_1.html'" />&nbsp; <input id="submitCertButton" type="button" class="inp_L1" value="提交" onmouseover="this.className='inp_L2'" onmouseout="this.className='inp_L1'"
