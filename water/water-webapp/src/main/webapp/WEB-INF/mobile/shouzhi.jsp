	...
	<div data-role="page">
		...
		<div data-role="header" data-position="fixed" data-tap-toggle="false" class="header-div">
			<div class="header-title1">
				...
				<span class="header-title1-right" onclick="window.location.href='${ctx }/spring/mobile/shouzhiQuery?systemId=${systemId }'"><img alt="" src="${ctx }/images/search.png" height="25" width="25"></span>
			</div>
