			...
			<form action="echo.cfm" method="post">
				...
				<div data-role="fieldcontain">
					<label for="name">开始时间:</label> <input id="beginDT" name="beginDT" type="date" data-role="datebox"
						data-options='{"mode": "calbox", "calHighToday": false, "useInline": true, "fullScreen": true, "fullScreenAlways": true, "useInlineHideInput": true, "calTodayButton": true, "highDates": [@dateArray]}' />
				</div>

				<div data-role="fieldcontain">
					<label for="name">结束时间:</label> <input id="EndDT" name="EndDT" type="date" data-role="datebox"
						data-options='{"mode": "calbox", "calHighToday": false, "useInline": true, "fullScreen": true, "fullScreenAlways": true, "useInlineHideInput": true, "calTodayButton": true, "highDates": [@dateArray]}' />
				</div>
