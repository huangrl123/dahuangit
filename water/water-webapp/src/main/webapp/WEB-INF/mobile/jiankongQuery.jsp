                ...
                <ul data-role="listview" data-inset="true">
                    ...
                    <li>
						<div data-role="fieldcontain">
							<label for="name">开始时间:</label><input id="startTime" type="text" data-role="datebox" placeholder="请选择">
						</div>
	                </li>
	                
	                <li>
						<div data-role="fieldcontain">
							<label for="name">结束时间:</label> <input id="endTime" type="text" data-role="datebox" placeholder="请选择">
						</div>
	                </li>
	                
	                <li>
						<div data-role="fieldcontain">
							<label for="name">项目:</label> <select placeholder="请选择">
