	...
	<div data-role="page">
		...
		<div data-role="header" data-position="fixed" data-tap-toggle="false" class="header-div">
			<div class="header-title1">
				<span class="header-title1-left" onclick="window.location.href='${ctx }/spring/mobile/functionList?systemId=${systemId }'"><img alt="" src="${ctx }/images/home.png" height="25" width="25"></span> <span class="header-title1-center">收支统计表</span>
				<span class="header-title1-right" onclick="window.location.href='${ctx }/spring/mobile/sunyiQuery?systemId=${systemId }'"><img alt="" src="${ctx }/images/search.png" height="25" width="25"></span>
			</div>
		...
		<div data-role="content">
			...
			<ul data-role="listview">
				...
				<li><span class="list-item-left">收支合计</span> <span class="list-item-right">￥${semesterSumInfo.sumInout }</span></li>
				<li><span class="list-item-left">消费合计</span> <span class="list-item-right">￥${semesterSumInfo.sumXf }</span></li>
				<li><span class="list-item-left">赠送合计</span> <span class="list-item-right">￥${semesterSumInfo.sumZs }</span></li>
				<li><span class="list-item-left">成本合计</span> <span class="list-item-right">￥${semesterSumInfo.sumCb }</span></li>
				<li><span class="list-item-left">项目收益</span> <span class="list-item-right-total">￥${semesterSumInfo.sumSy }</span></li>

				<li data-role="list-divider" style="font-weight: bolder; color: #7a7b7f; font-size: 16; background-color: e8ebe8;">学期月份收益</li>
				<li><span id="semesterMonthInfos"></span></li>

				<li data-role="list-divider" style="font-weight: bolder; color: #7a7b7f; font-size: 16; background-color: e8ebe8;">最近三年收益</li>
				<li><span id="recentYearSemesterMonthInfos"></span></li>
			</ul>
