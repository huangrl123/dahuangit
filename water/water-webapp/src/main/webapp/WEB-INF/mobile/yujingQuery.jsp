...
<body>
	<div data-role="page">
		...
		<div data-role="header">
			<a href="${ctx }/spring/mobile/yujing" data-icon="back" data-ajax="false" onclick="showLoader()">返回</a>
			<h1>设备预警情况查询</h1>
		</div>

		<div data-role="content">

			<form id="yujingQueryForm" action="${ctx }/spring/mobile/yujing" method="get" data-ajax="false">
